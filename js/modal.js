...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const inputTextParaModal = {
        ...
        moreInfo: "<h3><b>Site Info:</b></h3>This site was built using vanilla JavaScript, HTML, and CSS. The page animations were created with CSS animations. The animated <a href='https://codepen.io/Sneha_P_P/pen/LXWWox' target='_blank'>coffee cup</a> and <a href='https://codepen.io/semdeck/pen/abQBwKN' target='_blank'>star/shooting stars</a> are adapted from example code found on <a href='https://codepen.io/' target='_blank'>CodePen</a>. Special thanks to <a href='https://codepen.io/Sneha_P_P' target='_blank'>Sneha P P</a> and <a href='https://codepen.io/semdeck' target='_blank'>SEMdeck Digital</a> on CodePen for their inspiring examples. The code has been modified and is used under the MIT License. All license/copyright information can be found in the respective files that include code used from these examples in comments at the top of the file. The license information for this project can be found <a href='https://github.com/CodingANDCoffeeEQHappy/CodingANDCoffeeEQHappy.github.io/blob/main/LICENSE' target='_blank'>here</a>. The GitHub repo for this project can also be found <a href='https://github.com/CodingANDCoffeeEQHappy/CodingANDCoffeeEQHappy.github.io/' target='_blank'>here</a>.<br/><br/><h3><b>Projects:</b></h3><a href='./space/space.html' target='_blank'>Visit Outer Space</a>"
    };
